...
<template>
    ...
    <div class="container mx-auto px-5">
        <header class="flex justify-between py-12 items-center">
            <div>
                <a href="/"><img src="../assets/images/logo.png" alt="Site Logo" width="250" height="200"></a>
            </div>
            ...
            <nav class="flex justify-end flex-col md:flex-row">
                ...
                <ul class="space-x-10 font-theme-heading font-medium items-center hidden md:flex  flex-col space-y-7 md:space-y-0 md:flex-row">
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="http://localhost:3000/NutriSync/plan" >Plans</a></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="http://localhost:3000/NutriSync/faq" >FAQ</a></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="http://localhost:3000/NutriSync/about" >About</a></li>
                    <li class="uppercase bg-theme-secondary px-6 py-2 text-white rounded shadow-md hover:bg-white border-2 border-transparent hover:border-theme-secondary hover:text-theme-secondary cursor-pointer transition duration-200">
                        <a href="http://localhost:3000/NutriSync/contact">Contact</a>
                    </li>
                </ul>
            </nav>
        </header>
